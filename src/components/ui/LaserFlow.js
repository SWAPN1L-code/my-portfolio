...
export const LaserFlow = ({
    ...
    useEffect(() => {
        ...
        const { r: br, g: bg, b: bb } = hexToRGB(backgroundColor);
    ...
    useEffect(() => {
        ...
        const { r: br, g: bg, b: bb } = hexToRGB(backgroundColor || '#000000');
        rendererRef.current?.setClearColor(new THREE.Color(br, bg, bb), 1);
    }, [
        wispDensity,
        mouseTiltStrength,
